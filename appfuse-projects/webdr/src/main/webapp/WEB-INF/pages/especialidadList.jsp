...
<s:set name="especialidades" value="pacientes" scope="request"/>
<display:table name="especialidades" class="table" requestURI="" id="especialidadList" export="true"
               pagesize="25">
    <display:column property="id" sortable="true" url="editEspecialidad.html?from=list"
                    paramId="id" paramProperty="id" titleKey="paciente.id"/>
    <display:column property="nombre" sortable="true" titleKey="paciente.nombre"/>
    <display:column property="descripcion" sortable="true" titleKey="paciente.apellido"/>
